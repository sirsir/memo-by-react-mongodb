...
var PageObjectBase = function () {
  ...
  _createClass(PageObjectBase, [{
    ...
    key: 'portal',
    get: function get() {
      return new _enzyme.ReactWrapper(this.mountedComponent.instance().select.dropdownRef, true);
    }
  }, {
    key: 'isOpened',
    get: function get() {
    ...
    key: 'trigger',
    get: function get() {
      return new _enzyme.ReactWrapper(this.mountedComponent.instance().select.triggerRef, true);
    }
  }, {
    key: 'isDisabled',
    get: function get() {
